 ...
 * @author Admin
 */
public class ClientStatControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        list=csd.getClientStatList(startdate, enddate);
        if(list.size()==0){
        ...
        response.sendRedirect("clientstats.jsp");
        //request.getRequestDispatcher("clientstats.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ClientStatControl.class.getName()).log(Level.SEVERE, null, ex);
