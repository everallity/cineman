<%-- 
    Document   : footer
    Created on : Mar 23, 2022, 9:49:58 AM
    Author     : Admin
--%>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">CINNEXT<span></span></h5>
                        <p>Welcome to Cinnext.</p>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget no-box">
                        ...
                        <p>Subscribe To CINNEXT</p>
                        <a class="button" href="#" target="_blank">Subscribe Now</a>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="widget no-box">
                        ...
                        <p><a href="#" title="glorythemes">cinnext@gmail.com</a></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright CINNEXT 2022. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
